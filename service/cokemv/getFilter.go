...
const cokemvFilterUrl = "https://cokemv.me/vodshow/%s-----------.html"

func GetFilterMap(t string) (res model.Filters) {
	url := fmt.Sprintf(cokemvFilterUrl, t)
	client := resty.New()
	get, err := client.R().
	...
	str := utils.GetBetweenStr(get.String(), "module-class-item scroll-content", `module-main module-page`)

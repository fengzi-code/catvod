...
const rxlgSearchUrl = "https://caiji.rx.rongxingvr.cc:7777/rongxingapi.php/provide/vod/from/rx/?ac=list&wd=%s&ac=detail"

func (this *RXLG) Search(wd string) (res []model.VodInfo) {
	url := fmt.Sprintf(rxlgSearchUrl, wd)

...
const rxzhCateGoryApi = "http://103.222.188.156:99/rongxingapi.php/provide/vod/?ac=list&ac=detail&t=%s&pg=%d"

func (this *RXZH) GetCategory(typeId string, page int) (res model.Category) {
	url := fmt.Sprintf(rxzhCateGoryApi, typeId, page)
